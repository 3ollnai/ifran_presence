...
<div class="bg-white shadow-lg rounded-lg p-6">
    ...
    <div class="mb-6">
        <h2 class="text-xl font-medium mb-4 text-gray-800">Taux de Présence par Jour</h2>
            ...
            <table class="w-full table-auto border-collapse border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 border border-gray-300">{{ $absence->statut->statut }}</td>
...
<script>
    ...
    var presenceChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [{{ implode(',', $presenceChartLabels) }}],
            datasets: [{
                label: 'Taux de Présence',
                data: [{{ implode(',', $presenceChartData) }}],
