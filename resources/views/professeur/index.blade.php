    ...
    <div class="container mx-auto py-10">
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8 flex items-center justify-between">
            <div class="flex items-center">
                <i class="fas fa-user-circle text-blue-500 mr-6 text-4xl"></i>
                <h1 class="text-2xl font-bold">Bonjour, <span class="text-blue-500">{{ auth()->user()->prenom }} {{ auth()->user()->nom }}</span> !</h1>
            </div>
            <img src="{{ url('https://cdn.discordapp.com/attachments/1404249843878199408/1413567593805250671/image.png?ex=68bc66e9&is=68bb1569&hm=4b2aae9139a64fe61917700d1c483e94c202ae3c4d272f58597ec8950b9f51e0&') }}" alt="Profile Image" class="h-16 w-16 rounded-full">
        </div>

        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 class="text-xl font-semibold mb-6">Mes Prochains Cours</h2>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="px-6 py-4 text-left font-medium">Module</th>
                            <th class="px-6 py-4 text-left font-medium">Classe</th>
                            <th class="px-6 py-4 text-left font-medium">Étudiants</th>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="grid grid-cols-3 gap-8">
                <div class="bg-indigo-100 p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-4xl font-bold text-indigo-600">{{ count($absencesjustifiees) }}</p>
                </div>
                <div class="bg-indigo-100 p-6 rounded-lg shadow-md">
                    <h3 class="text-lg font-semibold mb-2">
                        <i class="fas fa-chart-line text-blue-500 mr-2"></i>
                ...
                <div class="bg-indigo-100 p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-4xl font-bold text-indigo-600">{{ count($absencesRecentes) }}</p>
                </div>
            </div>
        </div>
    </div>
