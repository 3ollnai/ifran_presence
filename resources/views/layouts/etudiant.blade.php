      ...
      <aside class="w-64 bg-white border-r flex flex-col justify-between">
          <div>
              ...
              <nav class="mt-8">
                  <ul>
                      <li>
                          <a href="#" class="flex items-center px-6 py-3 font-semibold rounded-r-full mb-2 text-violet-700 bg-violet-100">
                      ...
                      <li>
                          <a href="#" class="flex items-center px-6 py-3 font-semibold rounded-r-full mb-2 text-gray-700 hover:bg-violet-50">
                              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
