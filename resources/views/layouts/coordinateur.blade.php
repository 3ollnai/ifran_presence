            ...
            <div>
                ...
                <nav class="mt-8">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('coordinateur.stats') }}"
                               class="flex items-center px-6 py-3 font-semibold rounded-r-full mb-2
                                {{ request()->routeIs('coordinateur.stats') ? 'text-violet-700 bg-violet-100' : 'text-gray-700 hover:bg-violet-50' }}">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            @if(auth()->check())
                <div class="p-6 flex items-center gap-3 border-t bg-violet-50">
                    ...
                    <span class="font-medium">
                        ...
                        <span class="ml-2 px-2 py-0.5 text-xs rounded bg-violet-200 text-violet-800 font-semibold">Coordinateur</span>
                    </span>
        ...
        <main class="flex-1 flex flex-col">
            ...
            <header class="bg-white border-b flex items-center justify-between px-8 py-3">
                ...
                <div class="flex items-center gap-4">
                    <form>
                        <input type="text" placeholder="Rechercher..." class="rounded-lg border px-3 py-1.5 text-sm focus:ring-violet-400 focus:border-violet-400">
                    </form>
                    ...
                    <img src="https://i.pravatar.cc/32?img=1" alt="Coordinateur" class="w-8 h-8 rounded-full border-2 border-violet-300">
                </div>
            </header>
            {{-- Page Content --}}
